      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="bg-black rounded-lg overflow-hidden border-2 border-gray-700 aspect-video">
            {/* React Player akan secara otomatis menangani streaming HLS */}
            <ReactPlayer
              url="https://jensen-zoonal-terresa.ngrok-free.dev/live/playlist.m3u8" // <-- GANTI DENGAN URL NGROK + path
              playing={true}   // Mulai otomatis
              muted={true}     // Wajib untuk autoplay di banyak browser
              controls={true}  // Tampilkan kontrol pemutar
              width="100%"
              height="100%"
              config={{
                file: {
